            ...
            <div className="bg-dark-800/90 border border-indigo-500/20 rounded-xl overflow-hidden mb-8 sticky top-4 shadow-md">
              ...
              <div className="p-6">
                ...
                {talent.details?.social && Object.values(talent.details.social).length > 0 && (
                  <div>
                    <h3 className="text-white mb-3 text-sm font-medium">Connect with {talent.name.split(' ')[0]}</h3>
                    <div className="flex gap-3">
                      {talent.details.social.twitter && (
                        <a href={`https://twitter.com/${talent.details.social.twitter.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-primary">
                      ...
                      {talent.details.social.github && (
                        <a href={`https://github.com/${talent.details.social.github}`} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-primary">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      {talent.details.social.linkedin && (
                        <a href={`https://linkedin.com/in/${talent.details.social.linkedin}`} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-primary">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      {talent.details.portfolio && (
                        <a href={talent.details.portfolio} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-primary">
