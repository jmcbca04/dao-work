    ...
    <section className="py-24 bg-neutral-50">
      <div className="container mx-auto px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Explore Skills Categories</h2>
          <p className="text-lg text-neutral-500 max-w-2xl mx-auto">
            Discover top talent across all Web3 domains
          </p>
        </div>
...
function CategoryCard({ icon, title }: CategoryCardProps) {
  return (
    <div className="bg-white shadow-sm hover:shadow-md transition-all rounded-xl border border-neutral-100 hover:border-neutral-200">
